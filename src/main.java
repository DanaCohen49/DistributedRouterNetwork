...
public class main {
    public static void main(String[] args) throws FileNotFoundException {
        String[] paths = {"C:\\Users\\User\\student files\\test_input_1.txt", "C:\\Users\\User\\student files\\test_input_2.txt", "C:\\Users\\User\\student files\\test_input_3.txt"}; //enter the path to the files you want to run here.
